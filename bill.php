...
<div class="container">
<div id="wrapper">
  <h1><center><b>Rakesh Billing System</b></center></h1>
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="bill.php"><span class="glyphicon glyphicon-inr"></span>&nbsp;Billing</a></li>
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='paybill.php?id=".$row['id']."'><span class=\"btn btn-info btn-xs glyphicon glyphicon-inr\">Run</span> </a>| ";
