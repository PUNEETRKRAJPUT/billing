...
<div id="data">
<center>
<h4><center><b>Rakesh Billing System</b></center></h4>
<p>Gujrat - ahemdabad</p>
...
<tr><td bordercolor="#000000">Amount Paid :</td><td><b><i> <?php echo $prev;?> </td><td bordercolor="#000000">Total Amount : </td><td><b><i><?php echo $pres; ?> </td></tr>
<tr><td bordercolor="#000000">Bill to be paid: </td><td><b><i><?php echo $totalcons;?> </td><td bordercolor="#000000">Price / unit : </td>
<td><b><i><?php echo $price; ?>&nbsp;Tshs </td>
</tr>
<tr><td colspan="4"><center><h2>Total Invoice:<b><i> <?php echo $totalcons; ?><b><i> /= Rupees</h2></center></td></tr>
<?php
$session=$_SESSION['id'];
include 'db.php';
